...
- **Section Headings (project-specific copy when adding incentive UI):**
  ...
  - **Variant Toggle Sheet labels** (locked in I-4.2 + extended in I-4.4):
    ...
    - Section 3 (added I-4.4): **"Payout Summary"** with sub-copy "How the payout breakdown is laid out on the Upcoming Payout page."
      - "Mini-Cards Below" — `mini-cards` (default)
...
| `/payout` Summary layout | I-4.4 | 2 | `mini-cards` (default), `tabs-as-metrics` |
